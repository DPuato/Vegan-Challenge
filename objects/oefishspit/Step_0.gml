...
if die=false // if not dead then...
{
	...
	{
		hsp=myDir*movespeed; //Horizontal speed is equal to my direction (-1 for left, 1 for right) multiplicated by my moving speed, this means he will move horizontally to the right or left at the speed in movespeed.
	}
	else //If hurt then...
	{
