...
if oPlParent.y>y {myDir=1} else {myDir=-1} //This makes the enemy follow the player, if the player's X coordinate is bigger than mine, then the player is to the right (myDir=1), if not then he is to the left (myDir=-1).